...
def home_view(request):
	...
	# cids = ['dac', 'date', 'icpp', 'icdcs', 'iccad', 'ipdps', 'isca', 'podc', 'iccd', 'ics', 'hpca', 'sc', 'spaa', 'asplos', 'hpdc', 'acm_trans_embedded_comput_syst_tecs_', 'acm_trans_design_autom_electr_syst_todaes_', 'ppopp',]
